        ...
        <Box bg="lightblue" maxW="100vw" minH="100vh" overflowY="auto" overflowX = "hidden" p={4} d="flex" flexDirection="column" alignItems="center">
            ...
            <Box textAlign="left" mt="60px" mx="15%" fontWeight="medium" fontFamily="'Times New Roman', sans-serif" lineHeight="2.0">
                ...
                <Box mx="0%" display="flex" justifyContent="flex-start">
                    <Image 
                        src="images/Logos/walmartLogo.jpg"
                        alt="Walmart Logo"
                        mt="20px" 
                        w={{ base: "350px", sm: "30%" }}
                        minWidth="200px"  
                ...
                <Flex textAlign="left" fontSize="1.0em">
                    ...
                    <Box fontWeight="medium">
                        ...
                        completed final round interview with SWE at Walmart (06/05) <span>&rarr;&nbsp;</span> 
                        passed interviews but on hiring pause (07/01)
                    </Box>
                </Flex>
                <br/>
                <Flex textAlign="left" fontSize="1.0em">
                    ...
                    <Box fontWeight="medium">
                        ...
                        My recruiter also had a very slow response time and was out of office multiple times when I tried reaching out. 
                    </Box>
                </Flex>
            </Box>
            ...
            <Box textAlign="left" mt="60px" mx="15%" fontWeight="medium" fontFamily="'Times New Roman', sans-serif" lineHeight="2.0">
                ...
                <Flex textAlign="left" fontSize="1.0em">
                    ...
                    <Box fontWeight="medium">
                        Applied online with referral (06/17) <span>&rarr;&nbsp;</span> 
                    </Box>
                </Flex>
                <br/>
                <Flex textAlign="left" fontSize="1.0em">
            ...
            <Box textAlign="left" mt="60px" mx="15%" fontWeight="medium" fontFamily="'Times New Roman', sans-serif" lineHeight="2.0">
                ...
                <Flex textAlign="left" fontSize="1.0em">
                    ...
                    <Box fontWeight="medium">
                        Applied online with referral (07/03) <span>&rarr;&nbsp;</span> 
                        received OA (07/04) <span>&rarr;&nbsp;</span> 
                        completed OA - passed 8/15 test cases for first question and 3/15 test cases for second question (07/11) <span>&rarr;&nbsp;</span> 
                    </Box>
                </Flex>
                <br/>
                <Flex textAlign="left" fontSize="1.0em">
